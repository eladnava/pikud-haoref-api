...
function extractAlertFromJSON(json, callback) {
    ...
    alert.type = getAlertTypeByCategory(json.cat, json.title);
...
function getAlertTypeByCategory(category, title) {
