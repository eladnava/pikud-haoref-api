...
function* geocodeCity(city, options) {
    ...
    var json = yield request({ url: 'https://maps.googleapis.com/maps/api/geocode/json?components=locality:' + encodeURIComponent(city.name) + '&key=' + options.googleMapsApiKey, json: true });
