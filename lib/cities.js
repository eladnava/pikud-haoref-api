...
function* fetchCountdown(city, options) {
    ...
    var html = yield request('https://www.oref.org.il/Shared/Ajax/GetInstructionsByArea.aspx?lang=he&RiFid=1087&from=1&cityid=' + city.cityId + '&streetid=&ctlabel=' + escape(city.name) + '&stlabel=&house=&lat=00.00&lng=00.00&label=' + escape(city.name) + '&area=' + city.areaId + '&address=' + escape(city.name), options);
