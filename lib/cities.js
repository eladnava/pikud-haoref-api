...
function* geocodeCity(city, options) {
    ...
    var json = yield request({ url: 'https://maps.googleapis.com/maps/api/geocode/json?address=' + encodeURIComponent(city.name) + '&key=' + options.googleMapsApiKey, json: true });
